...
module.exports.run = function ({ api, event, args, prefix, admin }) {
    ...
    if (userPrefix) {
        messageBody = `Yo, my prefix is [ 𓆩 ${userPrefix} 𓆪 ]\n\n𝗦𝗢𝗠𝗘 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 𝗧𝗛𝗔𝗧 𝗠𝗔𝗬 𝗛𝗘𝗟𝗣 𝗬𝗢𝗨:\n➥ ${userPrefix}help [number of page] -> see commands\n➥ ${userPrefix}sim [message] -> talk to bot\n➥ ${userPrefix}callad [message] -> report any problem encountered\n➥ ${userPrefix}help [command] -> information and usage of command\n\nHave fun using it, enjoy! ❤️\nBot Developer: https://www.facebook.com/${admin}`;
    } else {
